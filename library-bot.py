...
async def on_member_update(before, after):
    if before.roles != after.roles:
        ...
        if patron in after.roles and patron not in before.roles:
            ...
            await after.send("Welcome back to the Vel's Library discord server! You can customize the channels you want to see here <id:browse>! If you're having trouble or still missing channels, please submit a ticket through https://discord.com/channels/1148449914188218399/1192558831222411294 and we'll help you access them!")
