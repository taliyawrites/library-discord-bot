...
async def reminders(interaction):
    await interaction.response.defer()
    info_string = "You can sign up for daily reminder notifications in the https://discord.com/channels/1148449914188218399/1489744967940440285 by assigning yourself roles in <id:customize>. The times are listed there in ET, but you can see here how those translate to your local timezone! \n- :regional_indicator_a: Role A gets reminders at midnight ET (<t:1775275200:t>) \n- :regional_indicator_b: Role B gets reminders at at  4 AM ET (<t:1775203200:t>) \n- :regional_indicator_c: Role C gets reminders at at 8 AM ET (<t:1775217600:t>) \n- :regional_indicator_d: Role D gets reminders at at noon ET (<t:1775232000:t>) \n- :regional_indicator_e: Role E gets reminders at at 4 PM ET (<t:1775246400:t>) \n- :regional_indicator_f: Role F gets reminders at at 8 PM ET (<t:1775260800:t> \nNote that you may choose multiple options if you wish! You can opt-out of these notifications at any time by simply de-selecting the option on that same page.)"
