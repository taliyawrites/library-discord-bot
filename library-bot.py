...
async def on_message(message):
    ...
    if msg.startswith('!stream'):
        stream_info = 'Vel streams live every other Sunday on [Twitch](https://www.twitch.tv/velslibrary). The next stream, "How Vel Does Vel Know Vel?" (quizzing Vel on how well he knows his own content), will be <t:1722195000:F>!'
